...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide" >
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<img className='imgCarosule' style="width:100%; height:500px" src="images/carousel/2ii.png" alt=""/>
		  ...
		  <div class="item">
		  <div class="container">
			<img className='imgCarosule' style="width:100% ; height:500px;cursor:pointer" src="images/carousel/3ii.png" alt=""/>
				<div class="carousel-caption">
		  ...
		  <div class="item">
		  <div class="container">
			<img className='imgCarosule' style="width:100% ; height:500px;cursor:pointer" src="images/carousel/5ii.png" alt=""/>
			<div class="carousel-caption">
		   ...
		   <div class="item">
		   <div class="container">
			<img className='imgCarosule' style="width:100% ; height:500px; cursor:pointer" src="images/carousel/6ii.png" alt=""/>
			<div class="carousel-caption">
